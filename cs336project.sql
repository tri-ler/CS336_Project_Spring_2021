...
primary key (`username`, `R_username`)
foreign key (`username`) references user,			
foreign key (`R_username`) references representatives
)
UNLOCK TABLES;
...
INSERT INTO `Q&A` VALUES('When will the autcion start','You will recoeve an email','user1'),('When Will the new CPU avaiable','Pretty soon','user1'),('How to find my log in id or sign up?','Click the main page and opem the link','user2'); 
select * from `Q&A`;
UNLOCK tables;
