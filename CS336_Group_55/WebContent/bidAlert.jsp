...
<html>
	...
	<body>
		<% try {
			...
			+ "FROM auction, auctioning, computerpart, bids, (SELECT bidID, auctionID, username, bidAmount FROM bids WHERE (auctionID, bidAmount) IN (select AuctionID, max(bidAmount) FROM bids GROUP BY auctionID)) t1 "
